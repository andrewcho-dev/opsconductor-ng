#!/usr/bin/env python3
"""
Test SSH execution through Pipeline V2
Simulates a user request to connect to a Linux machine and execute a command
"""
...
async def test_ssh_request():
    ...
    print("=" * 80)
    print("Testing SSH Request through Pipeline V2")
    print("=" * 80)
    ...
    # User request - SSH command execution
    user_request = (
        "Connect to 192.168.50.12 with SSH using username root and password Enabled123! "
        "and get the directory listing of /root"
    )
...
if __name__ == "__main__":
    success = asyncio.run(test_ssh_request())
