...
class AIRouter:
    ...
    def __init__(self, redis_client: Optional[redis.Redis] = None):
        ...
        self.http_client = httpx.AsyncClient(timeout=120.0)  # Increased for pure LLM intelligence
    ...
    async def _make_request(
        ...
        try:
            ...
            response = await self.http_client.post(
                url,
                json=request_data,
                timeout=120.0  # Increased timeout for pure LLM intelligence processing
            )
